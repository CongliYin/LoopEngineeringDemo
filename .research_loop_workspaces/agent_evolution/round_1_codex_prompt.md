...
- round_1_validation.json，如果存在
- round_1_rule_validation.json，如果存在
- round_1_agent_validation.json，如果存在
...
当前 goal / validation context：
{
  ...
  "issues": [],
  "goal": "Create the first complete research_report.md and sources.json from brief.md and rubric.md. No previous validation exists yet.",
  "rule_validation": null,
